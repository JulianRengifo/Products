...
class ProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      padding: EdgeInsets.symmetric(horizontal: 20), //alineación tajeta
      child: Container(
        margin: EdgeInsets.only(top: 30, bottom: 50),
        width: double.infinity,
        height: 400,
        decoration: _cardBorders(), // decoración de la tarjeta
        child: Stack(
    ...
    return ClipRRect(
      ...
      child: Container(
        ...
        child: url == null
            ? Image(
                image: AssetImage(
                    'assets/no-image.png'), // imagen que se genera mientras carga la imagen inicial
                fit: BoxFit.cover)
            : FadeInImage(
